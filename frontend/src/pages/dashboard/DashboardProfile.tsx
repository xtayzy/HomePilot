          ...
          <form onSubmit={handleProfileSubmit} className="space-y-6">
            ...
            <div className="grid sm:grid-cols-2 gap-4 sm:gap-6">
              <div className="space-y-2">
                <label htmlFor="profile-first-name" className="text-sm font-medium text-stone-700">
                  Имя
                </label>
                <Input
              ...
              <div className="space-y-2">
                <label htmlFor="profile-last-name" className="text-sm font-medium text-stone-700">
                  Фамилия
                </label>
                <Input
              ...
              <div className="space-y-2 sm:col-span-2">
                <label htmlFor="profile-phone" className="text-sm font-medium text-stone-700">
                  Телефон
                </label>
                <Input
                  id="profile-phone"
